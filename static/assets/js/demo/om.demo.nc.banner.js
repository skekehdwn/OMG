...
var handleRenderChartNC = function () {
    ...
    osDonutValue.push(a.bannerDataList[5]['value']);
    osDonutName.push(a.bannerDataList[5]['name']);
    osDonutValue.push(a.bannerDataList[0]['value']);
    osDonutName.push(a.bannerDataList[0]['name']);
    osDonutValue.push(a.bannerDataList[1]['value']);
    osDonutName.push(a.bannerDataList[1]['name']);


    console.log(osDonutValue);
    console.log(osDonutName);
   ...
   //--------------------------------------------------------------------------
    ...
    document.querySelector('#om_um_chart'),
    om_um_chartOptions2
    );
    om_um_chart.render();
